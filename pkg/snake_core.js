...
export class SnakeGame {
     ...
     */
    constructor(canvas_id, grid_size) {
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.snakegame_new(ptr0, len0, grid_size);
        if (ret[2]) {
    ...
    change_direction(dx, dy) {
        wasm.snakegame_change_direction(this.__wbg_ptr, dx, dy);
    }
    /**
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('snake_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
